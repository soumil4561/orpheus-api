...
import { ApiDatasourceContext } from '@/types'

export abstract class ApiDatasource extends BaseDatasource<ApiDatasourceContext> {
  constructor(context: ApiDatasourceContext) {
    super(context)
  }
